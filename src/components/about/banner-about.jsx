...
const BannerAbout = () => {
    ...
    return (
        <section className="my-48 min-h-svh">
            <div className="container mx-auto px-10 flex flex-col-reverse gap-10 md:flex-row-reverse justify-between items-center">
                <div>
                    <img src={MePhoto} className="rounded-full w-80  h-80 object-cover"
